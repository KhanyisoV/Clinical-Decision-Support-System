...
namespace FinalYearProject.Data
{
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Allergy>().HasIndex(a => a.ClientId);

            modelBuilder.Entity<Allergy>().HasIndex(a => a.AllergyType);

            modelBuilder.Entity<Allergy>().HasIndex(a => a.Severity);

            modelBuilder.Entity<Allergy>().HasIndex(a => a.IsActive);

            modelBuilder.Entity<Allergy>().HasIndex(a => a.DiagnosedDate);
            ...
            // Add indexes for better query performance
            modelBuilder.Entity<LabResult>().HasIndex(lr => lr.ClientId);

            modelBuilder.Entity<LabResult>().HasIndex(lr => lr.TestDate);

            modelBuilder.Entity<LabResult>().HasIndex(lr => lr.Status);
            ...
            modelBuilder.Entity<Message>().HasIndex(m => m.SenderUsername);

            modelBuilder.Entity<Message>().HasIndex(m => m.ReceiverUsername);
