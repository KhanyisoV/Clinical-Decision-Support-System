...
namespace FinalYearProject.Controllers
{
    ...
    public class AppointmentController : ControllerBase
    {
        ...
        // PATCH: api/appointment/{id}/accept
[HttpPatch("{id}/accept")]
...
public IActionResult AcceptAppointment(int id)
{
    var appointment = _appointmentRepo.GetById(id);
    if (appointment == null)
        return NotFound(new ApiResponseDto { Success = false, Message = "Appointment not found" });
    ...
    var history = new AppointmentHistory
    {
        ...
        NewStatus = "Accepted",
        ChangeReason = "Appointment accepted by patient",
    ...
    return Ok(new ApiResponseDto { Success = true, Message = "Appointment accepted successfully" });
}

// PATCH: api/appointment/{id}/decline
[HttpPatch("{id}/decline")]
[Authorize(Roles = "Client")]
public IActionResult DeclineAppointment(int id, [FromBody] string? reason = null)
{
    var appointment = _appointmentRepo.GetById(id);
    if (appointment == null)
        return NotFound(new ApiResponseDto { Success = false, Message = "Appointment not found" });
    ...
    var history = new AppointmentHistory
    {
        ...
        PreviousStatus = oldStatus,
        NewStatus = "Declined",
        ChangeReason = reason ?? "Appointment declined by patient",
        ChangedBy = username ?? "Unknown",
        ChangedByRole = role ?? "Unknown",
        ChangedAt = DateTime.UtcNow
    };
    ...
    return Ok(new ApiResponseDto { Success = true, Message = "Appointment declined successfully" });
}
